      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            <h3>About Us</h3>
            <p style="color: silver" class="mb-5">IT Department is located at Level UL Of Help University ELM Damansara Campus.</p>
          ...
          <div class="col-md-5 mb-5">
            <div class="mb-5">
              ...
              <p style="color: silver">Monday to Saturday</strong> 8AM - 6PM</p>
			  <p style="color: silver">Sunday</strong> Closed</p>
            </div>
            <div>
              <h3>Contact Info</h3>
              <ul class="list-unstyled footer-link">
                ...
                <li class="d-block"><span class="d-block" style="color: silver">Telephone:</span><span class="text-white" style="color: silver">+6 03 20942000</span></li>
                <li class="d-block"><span class="d-block" style="color: silver">Email:</span><span class="text-white" style="color: silver">HelpUniversity@gmail.com</span></li>
              </ul>
            </div>
          </div>
