...
<h3 class="center"> IT Department Lecturer and Staff Details</h3>
    ...
    <div class="container" style="margin-top:2%;">
        ...
        <div class="row">
                <div class="col-sm-4">
                    ...
                    <p class="description">Dr Sien Ven Yu</p>
					<p class="description">Head of Information Technology's Department</p>
					<p class="description">BSc (Hons) (London) CompSc/, Maths MPhil, PhD (Queensland)</p>
                </div>
                <div class="col-sm-2">
                    <h3 class="drink"></h3>
                </div>
