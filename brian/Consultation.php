...
<div id="navbar">
  ...
  <a class="active" href="Consultation.php">Book Consultation</a> 
</div>
</nav>
       ...
       <?php if(isset($noBooking)){
        ...
        <div class="row">
          ...
          <?php while ($row10 = mysqli_fetch_array($results)) { ?>
           ...
           <div class="row">
                <div class="col-sm-6">
                    <h4>Do you have any question or needed a consultation with a lecturers?</h4>
                    <p>Please fill in the form and book the consultation date.  </p>
                </div>
        
        
                <div class="col-sm-6">
                    <h4>Availability For Consultation Date</h4>
					<p>Please check with the lecturer if he/she is free on that day. Booking date may be vary depend on the lecturer itself.</p>
